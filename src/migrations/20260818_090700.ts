...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_footer_socials_platform" AS ENUM('facebook', 'instagram', 'twitter', 'linkedin', 'youtube');
  ...
  CREATE TABLE "pages_blocks_contact" (
  	...
  	"description" varchar DEFAULT 'Have a question or want to work together? Drop us a message.',
  ...
  CREATE TABLE "homepage_integrations" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"name" varchar
  ...
  CREATE TABLE "homepage_pricing_features" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"feature" varchar
  ...
  CREATE TABLE "homepage" (
  	...
  	"cta_banner_subtitle" varchar,
  	"cta_banner_primary_cta_label" varchar,
  	"cta_banner_primary_cta_link" varchar,
  	"updated_at" timestamp(3) with time zone,
  	"created_at" timestamp(3) with time zone
  );
  ...
  ALTER TABLE "homepage_integrations" ADD CONSTRAINT "homepage_integrations_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."homepage"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "homepage_pricing_features" ADD CONSTRAINT "homepage_pricing_features_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."homepage_pricing"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "homepage_pricing" ADD CONSTRAINT "homepage_pricing_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."homepage"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "homepage_integrations_order_idx" ON "homepage_integrations" USING btree ("_order");
  CREATE INDEX "homepage_integrations_parent_id_idx" ON "homepage_integrations" USING btree ("_parent_id");
  ...
  CREATE INDEX "homepage_pricing_features_order_idx" ON "homepage_pricing_features" USING btree ("_order");
  CREATE INDEX "homepage_pricing_features_parent_id_idx" ON "homepage_pricing_features" USING btree ("_parent_id");
  CREATE INDEX "homepage_pricing_order_idx" ON "homepage_pricing" USING btree ("_order");
  CREATE INDEX "homepage_pricing_parent_id_idx" ON "homepage_pricing" USING btree ("_parent_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "homepage_integrations" CASCADE;
  DROP TABLE "homepage_testimonials" CASCADE;
  DROP TABLE "homepage_pricing_features" CASCADE;
